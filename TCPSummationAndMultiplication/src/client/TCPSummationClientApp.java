...
public class TCPSummationClientApp {
	...
	public static void main(String[] args) {
		...
		try {
			...
			int result2=dis.readInt();
			
			// 5. Further processing - display the result
			System.out.println("\tSending to the server: " + number1 + ", " 
					+ number2 + ","+number3);
			System.out.println("\tReceiving from server for summation: " + result);
			System.out.println("\tReceiving from server for multiplication: " + result2);
